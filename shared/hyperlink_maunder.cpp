// Doesn't work properly with dynamicly created control
// So, control should be in resource template
// A lot things to fix here!
...
{
// Disabled due permanent crash for ToolTip!    
...
void CHyperLink::SetURL(const char* const pszURL)
{
    m_strURL = pszURL;
    ...
    if (::IsWindow(GetSafeHwnd())) 
    {
        ...
        m_ToolTip.UpdateTipText(pszURL,this,TOOLTIP_ID);
    }
}
...
{
    if (!m_hLinkCursor)                // No cursor handle - load our own
    {
        // Get the windows directory
        CString   strWndDir;

        GetWindowsDirectory(strWndDir.GetBuffer(MAX_PATH + 1),MAX_PATH + 1);
...
void CHyperLink::ReportError(int nError)
{
   ...
   {    
      case 0:                       
      {  
         sErr = "The operating system is out\nof memory or resources."; 
         break;
      }
      case SE_ERR_PNF:              
      {  
         sErr = "The specified path was not found."; 
         break;
      }
      case SE_ERR_FNF:              
      {  
         sErr = "The specified file was not found."; 
         break;
      }
      case ERROR_BAD_FORMAT:        
      {  
         sErr = "The .EXE file is invalid\n(non-Win32 .EXE or error in .EXE image)."; 
         break;
      }
      case SE_ERR_ACCESSDENIED:     
      {  
         sErr = "The operating system denied\naccess to the specified file."; 
         break;
      }
      case SE_ERR_ASSOCINCOMPLETE:  
      {  
         sErr = "The filename association is\nincomplete or invalid."; 
         break;
      }
      case SE_ERR_DDEBUSY:          
      {  
         sErr = "The DDE transaction could not\nbe completed because other DDE transactions\nwere being processed."; 
         break;
      }
      case SE_ERR_DDEFAIL:          
      {  
         sErr = "The DDE transaction failed."; 
         break;
      }
      ...
      case SE_ERR_NOASSOC:          
      {  
         sErr = "There is no application associated\nwith the given filename extension."; 
         break;
      }
      case SE_ERR_OOM:              
      {  
         sErr = "There was not enough memory to complete the operation."; 
         break;
      }
      case SE_ERR_SHARE:            
      {  
      ...
      default:                      
      {  
         sErr.Format(_T("Unknown Error (%d) occurred."), nError); 
         break;
      }
   }
   
   sErr = "Unable to open hyperlink:\n\n" + sErr;
